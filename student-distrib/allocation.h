...
#define SLAB_ADDRESS 1024 * 1024 * 140 // 140mb is the beginning of the slab memory
...
struct kmem_slab
{
    ...
    kmem_cache *array_next; //array_next points to the next slab in the cache
    kmem_cache *array_prev;
    void *page_ptr;
    uint32_t size;
